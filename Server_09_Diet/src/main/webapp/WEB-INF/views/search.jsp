...
<style>
	...
	/*
		...
		padding 주었을때 좌, 우의 크기를 밖으로 보내지 않고
		내부로 흡수하는 옵션
	...
	*/
	tr:hover{
		...
		background-color: #abc; /*16진수 AA AA AA */ /* 10*10 10*10 10*10 */
		cursor:pointer;
	}
	input{
		border:1px solid green;
		...
		<c:choose>
			<c:when test="${not empty FOODS }">
				<table>
					...
					<%--
						Controller에서 전달받은
						FOODS(List type) Attribute를 for 반복문으로 반복하면서
