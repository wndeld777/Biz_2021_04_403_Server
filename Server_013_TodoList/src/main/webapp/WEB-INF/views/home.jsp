...
<style>
	...
	*{
	...
	table.td_list td.doit{
		...
		table이 아닌 box 형 tag의 경우 max-width 대신 width 값을 설정해야 한다
	...
	document.addEventListener("DOMContentLoaded",()=>{
		document.querySelector("table.td_list").addEventListener("dblclick",(ev)=>{
			...
			if(tagName == "TD"){
				...
				let confirm_msg = td_edate ? "완료를 취소합니다!!" : "TDDO를 완료했나요?"
...
<body>
	<h1>TO DO LIST</h1>
		...
		rootPath = http://localhost8080/todos
