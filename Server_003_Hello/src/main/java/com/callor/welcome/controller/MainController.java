...
// 그런데 Network과 관련된 코드는 너무 복잡하고 다양한 기술을 요구 하기 때문에 코드를 직접 작성하는 것은 너무 어렵다
...
//		http://localhost:8080 ㅡ> tomcat을 호출하는 Request
...
//		프로젝트내의 클래스 중에서 
//		@WebServlet("/home") Annotation 으로 설정된 클래스를 찾는다
...
public class MainController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		out.println("<h1>this is Main Controller</h1>");
		out.print("<a href='");
		out.print("http://localhost");
		out.print(":8080");
		out.print("/welcome/book'>");
		out.print("<h2>Book 으로</h2></a>");
		out.close();
