...
/* 
 ...
 이후에 작성된 CSS의 margin, padding을 원활히 적용시키기 위함이다
 
 box-sizing : border-box;
 Block type tag를 사용하여 화면을 그릴때
 Padding, margin, border 값을 지정할때
 좌, 우 로 벗어나서 그려지는 현상을 없애기 위한 설정
*/
*{
	margin:0;
	padding:0;
...
/*
	...
	nav#main ul {  }
	id가 main 인 nav Box 내부에 있는 ul tag에만 제한적으로 적용하라 하는 의미로 사용한다
...
<script>
	...
	*/
	document.addEventListener("DOMContentLoaded",function(){
		...
		메뉴의 항목인 ul > li tag 를 클릭했을때
		이벤트 버블링 효과에 의해 상단으로 이벤트가 전파되는 것을 역 이용하여
...
<nav id="main">
	<ul>
		...
		a tag 를 사용할때 a tag 의 기본 속성을 제거하고 새로운 속성을 부여하는
		CSS 코드를 추가 한다
		
		이러한 방식이 번거로워서 아예 a tag를 사용하지 않고
		다른 종류의 tag를 사용하여 메뉴를 구성하기도 한다
		
		여기에서는 <ul><li> tag를 조합하여
		상단의 메뉴를 생성하였다
		...
		메뉴와 관련된 부분을 스크립트에서 모아서 사용할수 있고
